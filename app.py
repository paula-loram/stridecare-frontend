...
# input user's params:
st.markdown("<h3 style='font-size:25px;'>Age</h3>", unsafe_allow_html=True)
age = st.number_input("Age", min_value=0, max_value=120, step=1, label_visibility="collapsed")

st.markdown("<h3 style='font-size:25px;'>Weight (kg)</h3>", unsafe_allow_html=True)
weight = st.number_input("Weight (kg)", min_value=0.0, max_value=300.0, step=0.1, label_visibility="collapsed")

st.markdown("<h3 style='font-size:25px;'>Height (cm)</h3>", unsafe_allow_html=True)
height = st.number_input("Height (cm)", min_value=0.0, max_value=300.0, step=0.1, label_visibility="collapsed")
